...
"""
    ontraportlibcontrollers.base_controller
...
class BaseController(object):
    ...
    global_headers = {
        'user-agent': config('ONTRAPORT_USER_AGENT', default='APIMATIC 2.0'),
        'Api-Key': config('ONTRAPORT_API_KEY', default=''),
        'Api-Appid': config('ONTRAPORT_APP_ID', default=''),
    }
